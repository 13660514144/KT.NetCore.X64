...
namespace KT.Elevator.Manage.Service.IServices
{
    ...
    public interface IHandleElevatorDeviceService
    {
        ...
        Task HandleElevator(HandleElevatorModel handleElevator);
        ...
        Task<HandledElevatorSuccessModel> RightHandleElevator(RightHandleElevatorModel rightHandleElevator);
    }
}
