...
namespace KT.Visitor.Interface.Views.Auth
{
    ...
    /// </summary>
    public partial class ReadIdCardPage : Page
    {
        private ILogger<ReadIdCardPage> _logger;
        private IdentityAuthActivePage _identityAuthActivePage;
        ...
        public ReadIdCardPage(ILogger<ReadIdCardPage> logger,
            IdentityAuthActivePage identityAuthActivePage,
