...
namespace KT.Visitor.Interface.Views.Auth
{
    ...
    /// </summary>
    public partial class IntegrateIdentityAuthActiveControl : UserControl
    {
        private IntegrateIdentityAuthActiveControlViewModel _viewModel;
        ...
        public IntegrateIdentityAuthActiveControl(IntegrateIdentityAuthActiveControlViewModel viewModel,
