...
{
    public class IntegrateInviteAuthSearchControlViewModel : BindableBase
    {
        ...
        public IntegrateInviteAuthSearchControlViewModel(VisitorAuthApi visitorAuthApi)
        {
        ...
        {
            var results = await _visitorAuthApi.AuthCheckAsync(new { askCode = _searchText });
