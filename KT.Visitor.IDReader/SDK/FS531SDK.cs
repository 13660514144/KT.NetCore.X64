...
namespace KT.Visitor.IdReader.SDK
{
    ...
    public class FS531SDK
    {
        ...
        public static int H531_Init()
        {
            ...
            var result = FS531SDKBase.H531_Init();
        ...
        public static int H531_getVersion(StringBuilder json)
        {
            ...
            var result = FS531SDKBase.H531_getVersion(json); 
            Logger.LogInformation($"H531证件扫描仪完成：H531_getVersion result:{result}");
            return result;
        }

        // 扫描识别 
        public static int H531_ScanOCR(string configJson, StringBuilder json)
        {
            Logger.LogInformation("H531证件扫描仪执行：H531_ScanOCR");
            var result = FS531SDKBase.H531_ScanOCR(configJson, json);
        ...
        public static int H531_CalibrateScanner()
        {
            ...
            var result = FS531SDKBase.H531_CalibrateScanner();
        ...
        public static int H531_GetButtonDownType()
        {
            ...
            var result = FS531SDKBase.H531_GetButtonDownType();
        ...
        public static int H531_FeedBackScanner()
        {
            ...
            var result = FS531SDKBase.H531_FeedBackScanner();
        ...
        public static string H531_GetError(int code)
        {
            ...
            var result = FS531SDKBase.H531_GetError(code);
        ...
        public static int OcrCamera_OCR(int Type, string PhotoPath, string outHeaderPath, StringBuilder outData, int outDataLen)
        {
            ...
            var result = FS531SDKBase.OcrCamera_OCR(Type, PhotoPath, outHeaderPath, outData, outDataLen);
            Logger.LogInformation($"H531证件扫描仪完成：OcrCamera_OCR result:{result}");
            return result;
        }
    }

    public class FS531SDKBase
    {
        // 初始化扫描仪
    ...
    /// 护照图片扫描人员信息数据结构模型
    /// </summary>
    public class ScanPassportPerson
    {
        //"Name":"CHEN ZHIMIN",                                                                                                
        public string Name { get; set; }
        //"NameCh":"陈志敏",                                                                                                   
    ...
    /// 驾照图片扫描人员信息数据结构模型
    /// </summary>
    public class ScanDriverLicense
    {
        // "Name": "陈钰贤",                               
        public string Name { get; set; }
    ...
    /// 直接扫描结果
    /// </summary>
    public class FS351Result
    {
        public int Code { get; set; }
        public string Type { get; set; }
        public string Message { get; set; }

        public FS351Person Data { get; set; }
    }

    /// <summary>
    /// 直接扫描参数
    /// </summary>
    public class ScanOCRQuery
    {
        [JsonProperty("goPath")]
