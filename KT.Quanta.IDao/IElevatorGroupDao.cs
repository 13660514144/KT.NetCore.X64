...
namespace KT.Quanta.Service.IDaos
{
    public interface IElevatorGroupDao : IBaseDataDao<ElevatorGroupEntity>
    {
        ...
        Task<List<ElevatorGroupEntity>> GetAllWithFloorsAsync();
        ...
        Task<List<ElevatorGroupEntity>> GetAllWithElevatorServersAndInfosAsync();
        Task<ElevatorGroupEntity> GetWithFloorsByIdAsync(string id);
    }
}
