...
namespace KT.Unit.Face.Arc.Pro.Utils
{
    ...
    public static class ASFFunctions
    {
        ...
        /// SDK动态链接库路径
        /// </summary>
        public const string Dll_PATH = "ReferenceFiles/Face/ArcFaceSdk/Pro/libarcsoft_face_engine.dll";
        ...
        public static extern int ASFDetectFaces(IntPtr pEngine, 
            int width, int height, int format, IntPtr imgData, 
            IntPtr detectedFaces, ASF_DetectModel detectModel = ASF_DetectModel.ASF_DETECT_MODEL_RGB);
