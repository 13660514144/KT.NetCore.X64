...
namespace KT.Quanta.Service.Devices.Schindler
{
    ...
    /// </summary>
    public class SchindlerTelegramHeaderRequest : SchindlerDatabaseSerializer
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public SchindlerTelegramHeaderRequest()
        {
            MessageId = SchindlerHelper.GetDatabaseMessageId();
        }
