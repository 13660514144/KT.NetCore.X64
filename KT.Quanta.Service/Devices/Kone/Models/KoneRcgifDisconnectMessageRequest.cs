...
namespace KT.Quanta.Service.Devices.Kone.Requests
{
    ...
    ///         实际返回结果不包含koneSubHeader1 //KoneRcgifHeaderRequest//
    /// 81 1F 00 00 00 00 80 00 80 66 00 01 00 00 00 00 00 00 00 00 00 20 48 AB 7F E3 1E D7 01 01 00
    /// </summary>
    public class KoneRcgifDisconnectMessageRequest : KoneRcgifSubHeader1Request
    {
        public KoneRcgifDisconnectMessageRequest()
        {
            ...
            ApplicationMsgType = (ushort)KoneRcgifApplicationMsgTypeEnum.DISCONNECT.Code;
            MajorVersion = 1;
            MinorVersion = 0;

            MessageId = KoneRcgifHelper.GetMessageId();
        }
