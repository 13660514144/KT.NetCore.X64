...
{
    public partial class CHCNetSDKCard
    {
        #region face add HCNetSDK.dll macro definition  
        ...
        public struct NET_DVR_DEVICEINFO_V40
        {
            ...
            public byte byCharEncodeType;     //字符编码类型0- 无字符编码信息(老设备)，1- GB2312(简体中文)，2- GBK，3- BIG5(繁体中文)，4- Shift_JIS(日文)，5- EUC-KR(韩文)，6- UTF-8，7- ISO8859-1，8- ISO8859-2，9- ISO8859-3，…，依次类推，21- ISO8859-15(西欧) 
        ...
        public struct NET_DVR_FACE_STATUS
        {
            ...
            public byte[] byCardNo;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = CHCNetSDKCard.ERROR_MSG_LEN, ArraySubType = UnmanagedType.I1)]
            ...
            {
                byCardNo = new byte[CHCNetSDKCard.ACS_CARD_NO_LEN];
                byErrorMsg = new byte[CHCNetSDKCard.ERROR_MSG_LEN];
                byRes = new byte[131];
            }
        }
        ...
        public struct NET_DVR_FACE_PARAM_CTRL_CARDNO
        {
            ...
            public byte[] byRes1;
            public CHCNetSDKCard.NET_DVR_FACE_PARAM_BYCARD struByCard;//按卡号的方式删除,读卡器暂时不写
        ...
        //[DllImport(@"Devices\Hikvision\Files\HCNetSDK.dll")]
        ...
        [DllImport(@"Devices\Hikvision\Files\HCNetSDK.dll")]
        public static extern int NET_DVR_GetNextRemoteConfig(int lHandle, ref CHCNetSDKCard.NET_DVR_FACE_RECORD lpOutBuff, int dwOutBuffSize);

        //[DllImport(@"Devices\Hikvision\Files\HCNetSDK.dll")]
        //public static extern bool NET_DVR_StopRemoteConfig(int lHandle);

        [DllImport(@"Devices\Hikvision\Files\HCNetSDK.dll")]
        public static extern int NET_DVR_SendWithRecvRemoteConfig(int lHandle, ref CHCNetSDKCard.NET_DVR_FACE_RECORD lpInBuff, int dwInBuffSize, ref CHCNetSDKCard.NET_DVR_FACE_STATUS lpOutBuff, int dwOutBuffSize, IntPtr dwOutDataLen);

        [DllImport(@"Devices\Hikvision\Files\HCNetSDK.dll")]
        public static extern bool NET_DVR_RemoteControl(int lUserID, int dwCommand, ref CHCNetSDKCard.NET_DVR_FACE_PARAM_CTRL_CARDNO lpInBuffer, int dwInBufferSize);

        [DllImport(@"Devices\Hikvision\Files\HCNetSDK.dll")]
        public static extern int NET_DVR_GetNextRemoteConfig(int lHandle, ref CHCNetSDKCard.NET_DVR_CAPTURE_FACE_CFG lpOutBuff, int dwOutBuffSize);
        #endregion
        #endregion
        ...
        public struct NET_DVR_SETUPALARM_PARAM
        {
            ...
            ///Tasking number and the (field dwTaskNo corresponding data upload NET_DVR_VEHICLE_RECOG_RESULT the same time issued a task structure NET_DVR_VEHICLE_RECOG_COND corresponding fields in dwTaskNo
            public ushort wTaskNo;

            /// <summary>
            /// deploy type:0-client deploy,1-real time deploy
            /// Client Deploy means you can accept real time event and offline events.
            /// Real Time Deploy means you can only accept real time events.
            /// </summary>
        ...
        public struct NET_DVR_CARD_CFG_V50
        {
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_DOOR_NUM_256 * MAX_CARD_RIGHT_PLAN_NUM, ArraySubType = UnmanagedType.I1)]
        ...
        public struct NET_DVR_IPDEVINFO_V31
        {
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = DEV_ID_LEN, ArraySubType = UnmanagedType.I1)]
        ...
        public struct NET_DVR_IPALARMOUTCFG_V40
        {
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_IP_ALARMIN_V40, ArraySubType = UnmanagedType.Struct)]
         ...
         */
        [DllImportAttribute(@"Devices\Hikvision\Files\HCNetSDK.dll")]
        ...
        public const int NET_DVR_SET_FACE = 2567;
        public const int NET_DVR_BULK_CHECK_FACE_PICTURE = 2533;
