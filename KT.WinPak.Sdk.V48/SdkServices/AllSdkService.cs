    ...
    public class AllSdkService : IAllSdkService
    {
        ...
        public void LoadClass()
        {
            lock (locker)
            {
                ...
                try
                {
                    _app = JsonConvert.DeserializeObject<ApplicationClass>(JsonConvert.SerializeObject(_app, JsonUtil.JsonSettings), JsonUtil.JsonSettings);
                }
                catch (Exception ex)
                {
                    _logger.LogError($"创建WinPak对象转换错误：{ex} ");
                }

                _wpAccountClass = new WPAccountClass();
                try
                {
                    _wpAccountClass = JsonConvert.DeserializeObject<WPAccountClass>(JsonConvert.SerializeObject(_wpAccountClass, JsonUtil.JsonSettings), JsonUtil.JsonSettings);
                }
                catch (Exception ex)
                {
                    _logger.LogError($"创建WinPak对象转换错误：{ex} ");
                ...
                try
                {
                    _cardHolderClass = JsonConvert.DeserializeObject<CardHolderClass>(JsonConvert.SerializeObject(_cardHolderClass, JsonUtil.JsonSettings), JsonUtil.JsonSettings);
                }
                catch (Exception ex)
                {
                    _logger.LogError($"创建WinPak对象转换错误：{ex} ");
                ...
                try
                {
                    _accessLevelClass = JsonConvert.DeserializeObject<AccessLevelClass>(JsonConvert.SerializeObject(_accessLevelClass, JsonUtil.JsonSettings), JsonUtil.JsonSettings);
                }
                catch (Exception ex)
                {
                    _logger.LogError($"创建WinPak对象转换错误：{ex} ");
                ...
                try
                {
                    _cardClass = JsonConvert.DeserializeObject<CardClass>(JsonConvert.SerializeObject(_cardClass, JsonUtil.JsonSettings), JsonUtil.JsonSettings);
                }
                catch (Exception ex)
                {
                    _logger.LogError($"创建WinPak对象转换错误：{ex} ");
                ...
                try
                {
                    _hwDeviceClass = JsonConvert.DeserializeObject<HWDeviceClass>(JsonConvert.SerializeObject(_hwDeviceClass, JsonUtil.JsonSettings), JsonUtil.JsonSettings);
                }
                catch (Exception ex)
                {
                    _logger.LogError($"创建WinPak对象转换错误：{ex} ");
        ...
        public WPAccountClass GetWPAccountClass()
        {
            lock (locker)
            {
                WPAccountClass wpAccountClass = null;
                try
                {
                    wpAccountClass = JsonConvert.DeserializeObject<WPAccountClass>(JsonConvert.SerializeObject(_wpAccountClass, JsonUtil.JsonSettings), JsonUtil.JsonSettings);
                }
                catch (Exception ex)
                {
                    _logger.LogError($"创建WinPak对象错误1：{ex} ");
                }

                if (wpAccountClass == null)
                {
                    try
                    {
                        wpAccountClass = new WPAccountClass();
                        wpAccountClass = JsonConvert.DeserializeObject<WPAccountClass>(JsonConvert.SerializeObject(wpAccountClass, JsonUtil.JsonSettings), JsonUtil.JsonSettings);
                        _wpAccountClass = JsonConvert.DeserializeObject<WPAccountClass>(JsonConvert.SerializeObject(wpAccountClass, JsonUtil.JsonSettings), JsonUtil.JsonSettings);
                    }
                    catch (Exception ex)
                    {
                        _logger.LogError($"创建WinPak对象错误2：{ex} ");
                    }
                }
        ...
        public CardHolderClass GetCardHolderClass()
        {
            lock (locker)
            {
                CardHolderClass cardHolderClass = null;
                try
                {
                    cardHolderClass = JsonConvert.DeserializeObject<CardHolderClass>(JsonConvert.SerializeObject(_cardHolderClass, JsonUtil.JsonSettings), JsonUtil.JsonSettings);
                }
                catch (Exception ex)
                {
                    _logger.LogError($"创建WinPak对象错误1：{ex} ");
                ...
                if (cardHolderClass == null)
                {
                    try
                    {
                        cardHolderClass = new CardHolderClass();
                        cardHolderClass = JsonConvert.DeserializeObject<CardHolderClass>(JsonConvert.SerializeObject(cardHolderClass, JsonUtil.JsonSettings), JsonUtil.JsonSettings);
                        _cardHolderClass = JsonConvert.DeserializeObject<CardHolderClass>(JsonConvert.SerializeObject(cardHolderClass, JsonUtil.JsonSettings), JsonUtil.JsonSettings);
                    }
                    catch (Exception ex)
                    {
                        _logger.LogError($"创建WinPak对象错误2：{ex} ");
        ...
        public AccessLevelClass GetAccessLevelClass()
        {
            lock (locker)
            {
                AccessLevelClass accessLevelClass = null;
                try
                {
                    accessLevelClass = JsonConvert.DeserializeObject<AccessLevelClass>(JsonConvert.SerializeObject(_accessLevelClass, JsonUtil.JsonSettings), JsonUtil.JsonSettings);
                }
                catch (Exception ex)
                {
                    _logger.LogError($"创建WinPak对象错误1：{ex} ");
                ...
                if (accessLevelClass == null)
                {
                    try
                    {
                        accessLevelClass = new AccessLevelClass();
                        accessLevelClass = JsonConvert.DeserializeObject<AccessLevelClass>(JsonConvert.SerializeObject(accessLevelClass, JsonUtil.JsonSettings), JsonUtil.JsonSettings);
                        _accessLevelClass = JsonConvert.DeserializeObject<AccessLevelClass>(JsonConvert.SerializeObject(accessLevelClass, JsonUtil.JsonSettings), JsonUtil.JsonSettings);
                    }
                    catch (Exception ex)
                    {
                        _logger.LogError($"创建WinPak对象错误2：{ex} ");
        ...
        public CardClass GetCardClass()
        {
            lock (locker)
            {
                ...
                try
                {
                    cardClass = JsonConvert.DeserializeObject<CardClass>(JsonConvert.SerializeObject(_cardClass, JsonUtil.JsonSettings), JsonUtil.JsonSettings);
                }
                catch (Exception ex)
                {
                    _logger.LogError($"创建WinPak对象错误1：{ex} ");
                ...
                if (cardClass == null)
                {
                    try
                    {
                        ...
                        cardClass = JsonConvert.DeserializeObject<CardClass>(JsonConvert.SerializeObject(cardClass, JsonUtil.JsonSettings), JsonUtil.JsonSettings);
                        _cardClass = JsonConvert.DeserializeObject<CardClass>(JsonConvert.SerializeObject(cardClass, JsonUtil.JsonSettings), JsonUtil.JsonSettings);
                    }
                    catch (Exception ex)
                    {
                        _logger.LogError($"创建WinPak对象错误2：{ex} ");
        ...
        public HWDeviceClass GetHWDeviceClass()
        {
            lock (locker)
            {
                HWDeviceClass hwDeviceClass = null;
                try
                {
                    hwDeviceClass = JsonConvert.DeserializeObject<HWDeviceClass>(JsonConvert.SerializeObject(_hwDeviceClass, JsonUtil.JsonSettings), JsonUtil.JsonSettings);
                }
                catch (Exception ex)
                {
                    _logger.LogError($"创建WinPak对象错误1：{ex} ");
                ...
                if (hwDeviceClass == null)
                {
                    try
                    {
                        hwDeviceClass = new HWDeviceClass();
                        hwDeviceClass = JsonConvert.DeserializeObject<HWDeviceClass>(JsonConvert.SerializeObject(hwDeviceClass, JsonUtil.JsonSettings), JsonUtil.JsonSettings);
                        _hwDeviceClass = JsonConvert.DeserializeObject<HWDeviceClass>(JsonConvert.SerializeObject(hwDeviceClass, JsonUtil.JsonSettings), JsonUtil.JsonSettings);
                    }
                    catch (Exception ex)
                    {
                        _logger.LogError($"创建WinPak对象错误2：{ex} ");
        ...
        public GetCardsByAccountNameQuery GetCardsByAccountName(GetCardsByAccountNameQuery query)
        {
            ...
            lock (locker)
            {
                _app.GetCardsByAccountName(query.bstrAcctName, query.bstrSubAcctName, out object vCards);
        ...
        public GetAccessLevelsByAccountNameQuery GetAccessLevelsByAccountName(GetAccessLevelsByAccountNameQuery query)
        {
            ...
            lock (locker)
            {
                _app.GetAccessLevelsByAccountName(query.bstrAccountName, query.bstrSubAccountName, out object vAccessLevels);
        ...
        public DeleteCardQuery DeleteCard(DeleteCardQuery query)
        {
            ...
            lock (locker)
            {
                _app.DeleteCard(query.bstrCardno, query.bstrAcctName, query.bstrSubAcctName, out int pStatus);
        ...
        public GetCardByCardNumberQuery GetCardByCardNumber(GetCardByCardNumberQuery query)
        {
            ...
            lock (locker)
            {
                _app.GetCardbyCardNumber(query.bstrCardno, query.bstrAcctName, query.bstrSubAcctName, out object vcard);
        ...
        public EditCardQuery EditCard(EditCardQuery query)
        {
            ...
            lock (locker)
            {
                _app.EditCard(query.bstrCardno, query.bstrAcctName, query.bstrSubAcctName, query.pcard, out int pStatus);
        ...
        public DeleteAccessLevelQuery DeleteAccessLevel(DeleteAccessLevelQuery query)
        {
            ...
            lock (locker)
            {
                _app.DeleteAccessLevel(query.bstrAcclName, query.bstrAcctName, out int pStatus);
        ...
        public IsolateAccessLevelQuery IsolateAccessLevel(IsolateAccessLevelQuery query)
        {
            ...
            lock (locker)
            {
                _app.IsolateAccessLevel(query.bstrAcclName, query.bstrAcctName, out object vCards, out int pStatus);
                _logger.LogInformation("执行结果：name:{0} vCards:{1} ", query.GetType().Name, JsonConvert.SerializeObject(vCards, JsonUtil.JsonPrintSettings));
                query.vCards = vCards;
                query.pStatus = pStatus;
            }
        ...
        public ConfigureAccessLevelQuery ConfigureAccessLevel(ConfigureAccessLevelQuery query)
        {
            ...
            lock (locker)
            {
                _app.ConfigureAccessLevel(query.bstrAcclName, query.bstrAcctName, query.vReaders, query.bstrTZName, out int pStatus);
        ...
        public GetAssociatedTimeZoneOfReaderQuery GetAssociatedTimeZoneOfReader(GetAssociatedTimeZoneOfReaderQuery query)
        {
            ...
            lock (locker)
            {
                _app.GetAssociatedTimeZoneOfReader(query.bstrAcclName, query.bstrAcctName, query.bstrReader, out object vTimezone);
        ...
        public GetCardHoldersByAccountNameQuery GetCardHoldersByAccountName(GetCardHoldersByAccountNameQuery query)
        {
            ...
            lock (locker)
            {
                _app.GetCardHoldersByAccountName(query.bstrAcctName, query.bstrSubAcctName, out object vCardHolders);
        ...
        public GetNoteFieldTemplateDetailsByAccountQuery GetNoteFieldTemplateDetailsByAccount(GetNoteFieldTemplateDetailsByAccountQuery query)
        {
            ...
            lock (locker)
            {
                _app.GetNoteFieldTemplateDetailsByAccount(query.bstrAcctName, query.bstrSubAcctName, out object vNFTemplates);
        ...
        public GetAccessLevelByNameQuery GetAccessLevelByName(GetAccessLevelByNameQuery query)
        {
            ...
            lock (locker)
            {
                _app.GetAccessLevelByName(query.bstrAcclName, query.bstrAcctName, out object VAccessLevel);
        ...
        public GetCardsWithoutCHIDByAcctIDQuery GetCardsWithoutCHIDByAcctID(GetCardsWithoutCHIDByAcctIDQuery query)
        {
            ...
            lock (locker)
            {
                _app.GetCardsWithoutCHIDByAcctID(query.lAcctID, query.lSubAcctID, out object vCards);
                _logger.LogInformation("执行结果：name:{0} vCards:{1} ", query.GetType().Name, JsonConvert.SerializeObject(vCards, JsonUtil.JsonPrintSettings));
                query.vCards = vCards;
            }
            _logger.LogInformation("结束执行操作操作：name:{0} data:{1} ", query.GetType().Name, JsonConvert.SerializeObject(query, JsonUtil.JsonPrintSettings));
        ...
        public BulkDeleteCardsQuery BulkDeleteCards(BulkDeleteCardsQuery query)
        {
            ...
            lock (locker)
            {
                _app.BulkDeleteCards(query.sStartNo, query.sStopNo, query.lAccountID, query.lSubAccountID, query.lOperID, query.sOpName);
        ...
        public BulkAddCardsQuery BulkAddCards(BulkAddCardsQuery query)
        {
            ...
            lock (locker)
            {
                _app.BulkAddCards(query.sStartNo,
                    query.sStopNo,
                    query.lAccountID,
                    query.lSubAccountID,
                    query.lCardStatus,
                    query.dtActivationDate,
                    query.dtExpirationDate,
                    query.lOperID,
                    query.sOpName,
                    query.bMultiple,
                    query.alAccessLevelIDs);
        ...
        public AddUpdateCardQuery AddUpdateCard(AddUpdateCardQuery query)
        {
            ...
            lock (locker)
            {
                _app.AddUpdateCard(query.dwRecordID,
                    query.sCardNo,
                    query.lAccountID,
                    query.lSubAccountID,
                    query.lCardStatus,
        ...
        public AddUpdateALQuery AddUpdateAL(AddUpdateALQuery query)
        {
            ...
            lock (locker)
            {
                _app.AddUpdateAL(query.dwAcceslevelID, query.sName, query.sDesc, query.lAccountID, query.anSubAccountIDs, query.anReaderIDs, query.anReaderTimeZones, query.anReaderGroups);
        ...
        public GetAssociatedGroupofReaderQuery GetAssociatedGroupofReader(GetAssociatedGroupofReaderQuery query)
        {
            ...
            lock (locker)
            {
                _app.GetAssociatedGroupofReader(query.bstrAcclName, query.bstrAcctName, query.bstrReader, out int lGroupID);
        ...
        public ConfigureEntranceAccessQuery ConfigureEntranceAccess(ConfigureEntranceAccessQuery query)
        {
            ...
            lock (locker)
            {
                _app.ConfigureEntranceAccess(query.bstrAcclName, query.bstrAcctName, query.bstrReaderName, query.bstrTZName, query.bstrGroupName, out int pStatus);
        ...
        public CreateAccessLevelQuery CreateAccessLevel(CreateAccessLevelQuery query)
        {
            ...
            lock (locker)
            {
                _app.CreateAccessLevel(query.bstrAcclName, query.bstrAcclDesc, query.vAcctlist, query.bstrAcctName, out int pStatus);
        ...
        public GetAccessTreeByNameQuery GetAccessTreeByName(GetAccessTreeByNameQuery query)
        {
            ...
            lock (locker)
            {
                _app.GetAccessTreeByName(query.bstrAcclName, query.bstrAcctName, out string pbstrAccessTree);
        ...
        public GetCardHolderSearchFieldsByAccountNameQuery GetCardHolderSearchFieldsByAccountName(GetCardHolderSearchFieldsByAccountNameQuery query)
        {
            ...
            lock (locker)
            {
                _app.GetCardHolderSearchFieldsByAccountName(query.bstrAcctName, query.bstrSubAcctName, out object vCHSearchFields);
        ...
        public GetCardHoldersOnSearchQuery GetCardHoldersOnSearch(GetCardHoldersOnSearchQuery query)
        {
            ...
            lock (locker)
            {
                _app.GetCardHoldersOnSearch(query.bstrAcctName, query.bstrSubAcctName, query.vInputSearchFields, query.vFieldData, query.vCompareType, out object vCardHolders);
                _logger.LogInformation("执行结果：name:{0} vCardHolders:{1} ", query.GetType().Name, JsonConvert.SerializeObject(vCardHolders, JsonUtil.JsonPrintSettings));
