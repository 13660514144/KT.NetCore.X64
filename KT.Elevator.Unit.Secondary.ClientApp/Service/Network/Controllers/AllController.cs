...
namespace KT.Elevator.Unit.Secondary.ClientApp.Service.Network.Controllers
{
    ...
    public class AllController
    {
        ...
        public async Task AddOrEditHandleElevatorDeviceAsync(UnitHandleElevatorDeviceModel data)
        {
            var service = ContainerHelper.Resolve<IHandleElevatorDeviceService>();
            _configHelper.LocalConfig = await service.AddOrEditAsync(data, _configHelper.LocalConfig);
        }
