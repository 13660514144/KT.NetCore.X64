...
using KT.Elevator.Unit.Secondary.ClientApp.Dao.Daos;
using KT.Elevator.Unit.Secondary.ClientApp.Dao.IDaos;
using KT.Elevator.Unit.Secondary.ClientApp.Device.Handlers;
...
using KT.Elevator.Unit.Secondary.ClientApp.Updates;
using KT.Elevator.Unit.Secondary.ClientApp.Views;
//using KT.Elevator.Unit.Secondary.ClientApp.WsScoket;//金地还原版本
...
namespace KT.Elevator.Unit.Secondary.ClientApp
{
    ...
    public partial class App : Prism.Unity.PrismApplication
    {
        ...
        {
            new EventWaitHandle(false, EventResetMode.AutoReset, "KT.Elevator.Unit.Secondary.ClientApp", out bool createNew);
        ...
        private async void InitDataAsync()
        {
            ...
            //启动http服务
            var apSettings = Container.Resolve<AppSettings>();
            _nettyServerHost = ContainerHelper.Resolve<INettyServerHost>();
            await _nettyServerHost.RunAsync(apSettings.Port + 1);
        ...
        protected override void RegisterTypes(IContainerRegistry containerRegistry)
        {
            ...
            containerRegistry.Register<Service.FaceHelpers.ArcFaceFree.IFaceService, Service.FaceHelpers.ArcFaceFree.FaceService>();
            containerRegistry.Register<Service.FaceHelpers.ArcFacePro.IFaceService, Service.FaceHelpers.ArcFacePro.FaceService>();
            ...
            containerRegistry.RegisterSingleton<Service.FaceHelpers.ArcFaceFree.FaceFactory>();
            containerRegistry.Register<Service.FaceHelpers.ArcFaceFree.IFaceProvider, Service.FaceHelpers.ArcFaceFree.FaceProvider>();
            containerRegistry.RegisterSingleton<Service.FaceHelpers.ArcFacePro.FaceFactory>();
            containerRegistry.Register<Service.FaceHelpers.ArcFacePro.IFaceProvider, Service.FaceHelpers.ArcFacePro.FaceProvider>();
           ...
           //串口初始化注入 日立
            ...
            //containerRegistry.RegisterSingleton<WebSocket4net>();
            //containerRegistry.RegisterSingleton<JobChkVer>();
            //初始化读卡器设备注入 
            containerRegistry.RegisterDeviceUnitTypes();
            containerRegistry.RegisterSingleton<SpeekVoice>();//语音实例
            // 初始化数据
            InitDataAsync();
        }
    }
