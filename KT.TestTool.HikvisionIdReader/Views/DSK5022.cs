...
namespace KT.TestTool.HikvisionIdReader.Views
{
    public class DSK5022 : IDevice
    {
        ...
        public void OnEnumDeviceCallBack(ref DSK5022SDK.USB_SDK_DEVICE_INFO pDevceInfo, IntPtr pUser)
        {
            ...
            _logger.LogInformation($"Hikvision device :{JsonConvert.SerializeObject(copyDeviceInfo, JsonUtil.JsonSettings)} ");
        ...
        //{
        //    _logger.LogInformation($"Hikvision device :{JsonConvert.SerializeObject(device, JsonUtil.JsonSettings)} ");
        ...
        //        _logger.LogInformation($"Hikvision userLoginInfo :{JsonConvert.SerializeObject(userLoginInfo, JsonUtil.JsonSettings)} ");
        //        _logger.LogInformation($"Hikvision deviceRegRes :{JsonConvert.SerializeObject(deviceRegRes, JsonUtil.JsonSettings)} ");
        ...
        {
            return DSK5022SDK.USB_SDK_Logout(_userId);
        }
        ...
        public Person ReadContent()
        {
            ...
            _logger.LogInformation($"用户信息：{JsonConvert.SerializeObject(result, JsonUtil.JsonSettings)} ");
