...
namespace KT.TestTool.SocketApp.Views
{
    ...
    public partial class TcpControl : UserControl
    {
        ...
        public TcpControl(ILogger<TcpControl> logger, TcpControlViewModel viewModel, SocketSettings socketSettings)
        {
            InitializeComponent();
        ...
        {
            SendMessageAsync(_viewModel.SocketInfo.SendText);
        }
