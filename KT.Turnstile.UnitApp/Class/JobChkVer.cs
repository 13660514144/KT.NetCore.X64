        ...
        public  class ChkVerChange
        {
            public  void ChkVer()
            {
                    ...
                    Dictionary<string, string> SendData = new Dictionary<string, string>
                {
                    ...
                    Dispatch _Dispatch = ContainerHelper.Resolve<Dispatch>();
                    string OwnerIp = AppConfigurtaionServices.Configuration["AppSettings:StartWithIp"].ToString(); 
                    string OwnerPort = AppConfigurtaionServices.Configuration["AppSettings:Port"].ToString();
                    ...
                    string Result = _Dispatch.ApiChkVer(Controller, SendData,Uri,_Port);
                    ...
                    if ((int)Data["Flg"] == 1 && O["DeviceType"].ToString().Trim() == Data["DeviceType"].ToString().Trim())
                    {
                        ...
                        string ChangeExe = "KT.Turnstile.Unit.ClientApp.exe";
                        //转自动下载
