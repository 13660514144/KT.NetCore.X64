    ...
    public class MainWindowViewModel : PropertyChangedBase
    {
        ...
        public MainWindowViewModel()
        {
            MenuItems = new ObservableCollection<TreeViewItemViewModel>()
            {
                ...
                new TreeViewItemViewModel("WinPak测试", "WinPakTestControl"),
                new TreeViewItemViewModel("Prowatch测试", "ProwatchTestControl"),
                new TreeViewItemViewModel("相机", "PhotographControl")
            };
        }
