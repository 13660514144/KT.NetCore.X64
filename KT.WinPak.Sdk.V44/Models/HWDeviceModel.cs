...
namespace KT.WinPak.SDK.Models
{
    ...
    public class HWDeviceModel
    {
        ...
        internal static List<HWDeviceModel> FromSqlEntities(List<Entities.HwindependentDevices> entities)
        {
        ...
        private static HWDeviceModel FromSqlEntity(Entities.HwindependentDevices entity)
        {
