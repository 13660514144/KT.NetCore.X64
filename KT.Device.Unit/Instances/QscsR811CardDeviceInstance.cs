...
{
    public class QscsR811CardDeviceInstance : IQscsR811CardDeviceInstance
    {
        public BrandModelEnum BrandModel => BrandModelEnum.QSCS_R811;

        private readonly IEventAggregator _eventAggregator;
        private readonly IDeviceList _deviceList;
        private readonly ILogger _logger;

        public QscsR811CardDeviceInstance()
        {
        ...
        private async void AddOrEditCardDeviceAsync(object obj)
        {
            ...
            try
            {
                ...
                //创建并打开串口 
                var newDevice = ContainerHelper.Resolve<IQscsR811CardDevice>();
