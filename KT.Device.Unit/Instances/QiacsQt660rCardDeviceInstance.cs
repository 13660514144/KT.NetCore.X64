...
{
    public class QiacsQt660rCardDeviceInstance : IQiacsQt660rCardDeviceInstance
    {
        public BrandModelEnum BrandModel => BrandModelEnum.QIACS_QT660_R;

        private readonly IEventAggregator _eventAggregator;
        private readonly IDeviceList _deviceList;
        private readonly ILogger _logger;

        public QiacsQt660rCardDeviceInstance()
        {
        ...
        private async void AddOrEditCardDeviceAsync(object obj)
        {
            ...
            try
            {
                ...
                //创建并打开串口 
                var newDevice = ContainerHelper.Resolve<IQiacsQt660rCardDevice>();
