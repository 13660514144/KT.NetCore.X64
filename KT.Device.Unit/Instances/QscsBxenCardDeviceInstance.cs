...
{
    public class QscsBxenCardDeviceInstance : IQscsBxenCardDeviceInstance
    {
        public BrandModelEnum BrandModel => BrandModelEnum.QSCS_BXEN;

        private readonly IEventAggregator _eventAggregator;
        private readonly IDeviceList _deviceList;
        private readonly ILogger _logger;

        public QscsBxenCardDeviceInstance()
        {
        ...
        private async void AddOrEditCardDeviceAsync(object obj)
        {
            ...
            try
            {
                ...
                //创建并打开串口 
                var newDevice = ContainerHelper.Resolve<IQscsBxenCardDevice>();
