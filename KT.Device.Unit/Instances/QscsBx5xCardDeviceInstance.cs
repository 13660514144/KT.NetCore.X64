...
{
    public class QscsBx5xCardDeviceInstance : IQscsBx5xCardDeviceInstance
    {
        public BrandModelEnum BrandModel => BrandModelEnum.QSCS_BX5X;

        private readonly IEventAggregator _eventAggregator;
        private readonly IDeviceList _deviceList;
        private readonly ILogger _logger;

        public QscsBx5xCardDeviceInstance()
        {
        ...
        private async void AddOrEditCardDeviceAsync(object obj)
        {
            ...
            try
            {
                ...
                //创建并打开串口 
                var newDevice = ContainerHelper.Resolve<IQscsBx5xCardDevice>();
