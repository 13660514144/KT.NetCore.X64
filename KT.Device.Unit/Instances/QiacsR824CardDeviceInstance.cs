...
{
    public class QiacsR824CardDeviceInstance : IQiacsR824CardDeviceInstance
    {
        public BrandModelEnum BrandModel => BrandModelEnum.QIACS_R824;

        private readonly IEventAggregator _eventAggregator;
        private readonly IDeviceList _deviceList;
        private readonly ILogger _logger;

        public QiacsR824CardDeviceInstance()
        {
        ...
        private async void AddOrEditCardDeviceAsync(object obj)
        {
            ...
            try
            {
                ...
                //创建并打开串口 
                var newDevice = ContainerHelper.Resolve<IQiacsR824CardDevice>();
