...
{
    public class QiacsR992CardDeviceInstance : IQiacsR992CardDeviceInstance
    {
        public BrandModelEnum BrandModel => BrandModelEnum.QIACS_R992;

        private readonly IEventAggregator _eventAggregator;
        private readonly IDeviceList _deviceList;
        private readonly ILogger _logger;

        public QiacsR992CardDeviceInstance()
        {
        ...
        private async void AddOrEditCardDeviceAsync(object obj)
        {
            ...
            try
            {
                ...
                //创建并打开串口 
                var newDevice = ContainerHelper.Resolve<IQiacsR992CardDevice>();
                await newDevice.StartAsync(obj);
                _logger.LogInformation($"二次读卡器=={JsonConvert.SerializeObject(obj)}");
                //向队列中添加串口
