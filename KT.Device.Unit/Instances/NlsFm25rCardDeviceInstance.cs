...
{
    public class NlsFm25rCardDeviceInstance : INlsFm25rCardDeviceInstance
    {
        public BrandModelEnum BrandModel => BrandModelEnum.NLS_FM25_R;

        private readonly IEventAggregator _eventAggregator;
        private readonly IDeviceList _deviceList;
        private readonly ILogger _logger;

        public NlsFm25rCardDeviceInstance()
        {
        ...
        private async void AddOrEditCardDeviceAsync(object obj)
        {
            ...
            try
            {
                ...
                //创建并打开串口 
                var newDevice = ContainerHelper.Resolve<INlsFm25rCardDevice>();
                await newDevice.StartAsync(obj);
                _logger.LogInformation($"二次二维码=={JsonConvert.SerializeObject(obj)}");
                //向队列中添加串口
