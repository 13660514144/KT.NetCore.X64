...
namespace KT.Quanta.Unit.Model.Requests
{
    ...
    /// 读卡器设备信息
    /// </summary> 
    public class HandleElevatorInputDeviceRequest : QuantaSerializer
    {
        /// <summary>
        /// 名称
        /// </summary>
        ...
        protected override void Read()
        {
            ...
            ReadTimeout = ReadInt();
            Encoding = ReadString();
            HandDeviceId = ReadString(); 
            HandDeviceRealId = ReadString();
            HandDeviceType = ReadString();
            HandDeviceEquipmentType = ReadString();
            HandDeviceIp = ReadString();
            HandDevicePort = ReadInt();
            HandDeviceCommunicateType = ReadString();
        }
        ...
        protected override void Write()
        {
            ...
            WriteString(HandDeviceId); 
            WriteString(HandDeviceRealId);
            WriteString(HandDeviceType);
            WriteString(HandDeviceEquipmentType);
            WriteString(HandDeviceIp);
            WriteInt(HandDevicePort);
            WriteString(HandDeviceCommunicateType);
        }
    }
}
