...
{
    public class DopSpecificMaskRecordDetailControlViewModel : BindableBase, IRegionMemberLifetime, INavigationAware
    {
        ...
        public DopSpecificMaskRecordDetailControlViewModel(IElevatorGroupApi elevatorGroupApi,
            IKoneApi koneApi,
            IMapper mapper,
        ...
        public void OnNavigatedTo(NavigationContext navigationContext)
        {
            ...
            var dopSpecificDefaultAccessMaskModel = JsonConvert.DeserializeObject<DopSpecificDefaultAccessMaskModel>(record.SendData, JsonUtil.JsonSettings);
            DopSpecificDefaultAccessMask = _mapper.Map<DopSpecificDefaultAccessMaskViewModel>(dopSpecificDefaultAccessMaskModel);
