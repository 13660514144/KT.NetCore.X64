...
namespace KT.Elevator.Unit.Processor.ClientApp.Dao.Base
{
    public class ElevatorUnitDbContext : DbContext
    {
        ...
        /// 电梯组
        /// </summary>
        public DbSet<UnitHandleElevatorDeviceEntity> HandleElevatorDevices { get; set; }

        /// <summary>
        /// 电梯组
        /// </summary>
        public DbSet<UnitElevatorGroupFloorEntity> ElevatorGroupFloors { get; set; }

        /// <summary>
        /// 电梯组
        /// </summary>
        public DbSet<UnitElevatorGroupEntity> ElevatorGroups { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<UnitElevatorGroupFloorEntity>()
            ...
            modelBuilder.Entity<UnitHandleElevatorDeviceEntity>();
            ...
            modelBuilder.Entity<UnitElevatorGroupEntity>();
