...
CREATE TABLE "ELEVATOR_GROUP" (
    "Id" TEXT NOT NULL CONSTRAINT "PK_ELEVATOR_GROUP" PRIMARY KEY,
    "Creator" TEXT NULL,
    "Editor" TEXT NULL,
    "CreatedTime" INTEGER NOT NULL,
    "EditedTime" INTEGER NOT NULL
...
CREATE TABLE "HANDLE_ELEVATOR_DEVICE" (
    ...
    "EditedTime" INTEGER NOT NULL,
    "ElevatorGroupId" TEXT NULL,
    CONSTRAINT "FK_HANDLE_ELEVATOR_DEVICE_ELEVATOR_GROUP_ElevatorGroupId" FOREIGN KEY ("ElevatorGroupId") REFERENCES "ELEVATOR_GROUP" ("Id") ON DELETE CASCADE
);
...
CREATE TABLE "ELEVATOR_GROUP_FLOOR" (
    "Id" TEXT NOT NULL CONSTRAINT "PK_ELEVATOR_GROUP_FLOOR" PRIMARY KEY,
    "Creator" TEXT NULL,
    "Editor" TEXT NULL,
    "CreatedTime" INTEGER NOT NULL,
    "EditedTime" INTEGER NOT NULL,
    ...
    CONSTRAINT "FK_ELEVATOR_GROUP_FLOOR_UNIT_FLOOR_FloorId" FOREIGN KEY ("FloorId") REFERENCES "UNIT_FLOOR" ("Id") ON DELETE CASCADE
);

CREATE UNIQUE INDEX "IX_CARD_DEVICE_PortName" ON "CARD_DEVICE" ("PortName");

CREATE INDEX "IX_ELEVATOR_GROUP_FLOOR_ElevatorGroupId" ON "ELEVATOR_GROUP_FLOOR" ("ElevatorGroupId");
...
VALUES ('20210322112653_v1.5.371', '3.1.7');
